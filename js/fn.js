...
var submit = (function () {
	...
	var callback = function (success, data, saltReqStat) {
		if ( typeof success !== 'boolean' ) { throw new Error('submit callback:  The first argument is not boolean.'); } else
		if ( typeof saltReqStat !== 'boolean' ) { throw new Error('submit callback:  The third argument is not boolean.'); }
